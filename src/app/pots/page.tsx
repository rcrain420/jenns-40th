            ...
            {HOST_FUNDED_POTS.map((pot) => (
              <li key={pot.id} className="flex gap-3">
                ...
                <span>
                  ...
                  and Aaron
                  {pot.id === "kids"
                    ? `. ${YOUTH_TOURNAMENT.tagline} Heaviest qualifying fish by a registered youth angler. Kids may fish from land or tag along on a boat without taking an adult seat. Youth are out of the main stringer and main pot. Attached to a paid team side pot, their fish may count there. Land-only kids are RowRide-only.`
