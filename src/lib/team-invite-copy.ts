/** Short My Team “Invite the boat” copy. No PIN / policy essay. */
...
export const INVITE_THE_BOAT_MEMBER_LINES = [
  "You’re on this boat. Share the link so other adults can create an account and join.",
  "Joining did not make you the captain or add you to the paid roster.",
] as const;
